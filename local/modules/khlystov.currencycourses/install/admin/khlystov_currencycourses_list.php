<?php
    ...
    if (is_dir($_SERVER["DOCUMENT_ROOT"] . "/bitrix/modules/khlystov.currencycourses/")) {
        ...
        require_once($_SERVER["DOCUMENT_ROOT"] . "/bitrix/modules/khlystov.currencycourses/admin/khlystov_currencycourses_list.php");
    }
    ...
    if (is_dir($_SERVER["DOCUMENT_ROOT"] . "/local/modules/khlystov.currencycourses/")) {
        // присоединяем и копируем файл
        require_once($_SERVER["DOCUMENT_ROOT"] . "/local/modules/khlystov.currencycourses/admin/khlystov_currencycourses_list.php");
    }
